...
#### 4. [Настроить VLAN управления для сетевых устройств](README.md#4-настроить-vlan-управления-для-сетевых-устройств-1);
...
Суммарная таблица LAN подсетей IPv4
<table>
  <tr>
    <th>Network IPv4</th>
    <th>Office</th>
    <th>Summary net IPv4</th>
    <th>Description</th>
  </tr>
  <tr>
    <th>10.0.0.0/14</th>
...
Суммарная таблица LAN подсетей IPv6
<table>
  <tr>
    <th>Network IPv6</th>
    <th>Office</th>
    <th>Summary net IPv6</th>
  </tr>
  <tr>
    <th>2001:FFCC:1000::/48</th>
    <th>Москва</th>
    <td rowspan="4">::32</td>
  <tr>
    <th>2001:FFCC:2000::/48</th>
    <th>Санкт-Петербург</th>
  </tr>
  <tr>
    <th>2001:FFCC:3000::/48</th>
    <th>Чокурдах</th>
  </tr>
  <tr>
    <th>2001:FFCC:4000::/48</th>
    <th>Лабытнанги</th>
  </tr>
</table>
...
10.1.12.0/24      | 10.0.0.0/14    | 2001:FFCC:1000:1415::/64 | 2001:FFCC:1000::/48 | Москва                 | R14e1/0 R15e1/0
...
Адреса **IPv4** будут, где это возможно, в последнем октете иметь цифру, совпадающую с номером маршрутизатора на схеме, например, для маршрутизатора **R12** адрес будет иметь вид **10.1.2.12**.

Адреса **IPv6** будут, где это возможно, в последнем хекстете иметь цифру, совпадающую с номером маршрутизатора на схеме, например, для маршрутизатора **R12** адрес будет иметь вид **2001:FFCC:1000:1214::12**.

**Link-local** адреса IPv6 будут в последнем хекстете иметь цифру, совпадающую с номером маршрутизатора на схеме, например, для маршрутизатора R12 все link-local адреса будут иметь вид **FE80::12**.
...
|:-----------|:-------|:--------|---------------------------:|:------------------------ |:-----------
R12          | E0/0   | IPv4    | 10.0.2.2/24                | 10.0.2.0/24              | R12 to SW4
R12          | E0/0   | IPv6    | 2001:FFCC:1000:2::2/64     | 2001:FFCC:1000:2::/64    | R12 to SW4
R12          | E0/0   | IPv6 LL | FE80::12/10                | FE80::/10                | Link-local e0/0
R12          | E0/1   | IPv4    | 10.0.3.2/24                | 10.0.3.0/24              | R12 to SW4
R12          | E0/1   | IPv6    | 2001:FFCC:1000:3::2/64     | 2001:FFCC:1000:3::/64    | R12 to SW4
R12          | E0/1   | IPv6 LL | FE80::12/10                | FE80::/10                | Link-local e0/1
...
R13          | E0/0   | IPv4    | 10.0.2.4/24                | 10.0.2.0/24              | R13 to SW4
R13          | E0/0   | IPv6    | 2001:FFCC:1000:2::4/64     | 2001:FFCC:1000:2::/64    | R13 to SW4
R13          | E0/0   | IPv6 LL | FE80::13/10                | FE80::/10                | Link-local e0/0
R13          | E0/1   | IPv4    | 10.0.3.4/24                | 10.0.3.0/24              | R13 to SW4
R13          | E0/1   | IPv6    | 2001:FFCC:1000:3::4/64     | 2001:FFCC:1000:3::/64    | R13 to SW4
R13          | E0/1   | IPv6 LL | FE80::13/10                | FE80::/10                | Link-local e0/1
...
R14          | E1/0   | IPv4    | 10.1.12.14/24              | 10.1.12.0/24             | R14 to R15
R14          | E1/0   | IPv6    | 2001:FFCC:1000:1415::14/64 | 2001:FFCC:1000:1415::/64 | R14 to R15
R14          | E1/0   | IPv6 LL | FE80::14/10                | FE80::/10                | Link-local e1/0
...
R15          | E1/0   | IPv4    | 10.1.12.15/24              | 10.1.12.0/24             | R15 to R14
R15          | E1/0   | IPv6    | 2001:FFCC:1000:1415::15/64 | 2001:FFCC:1000:1415::/64 | R15 to R14
R15          | E1/0   | IPv6 LL | FE80::15/10                | FE80::/10                | Link-local e1/0
...
-------------:|:--------------|---------------:|:--------------|:----------------:
172.16.0.0/14 | 172.16.0.0/14 | FD00::/8       | FD00::/8      | Mngm VLAN 999
|             |               |                |               |                  

Под служебный трафик выделен VLAN ID 999.
Адреса IPv4/IPv6, в последнем октете/хекстете будет иметь цифру, совпадающую с номером устройства на схеме. Например, для маршрутизатора R12, адреса будут иметь вид 172.168.0.12 и FD00::12.
