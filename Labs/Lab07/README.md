...
Link-local адреса IPv6 будут в последнем октете иметь цифру, совпадающую с номером маршрутизатора на схеме, например, для маршрутизатора R12 все link-local адреса будут иметь вид FE80::12. Link-local адреса IPv6 располагаются в подсети FE80::/10.
