...
### Задачи
#### Часть 1. [Построение сети и загрузка настроек устройств](READM.md#часть-1-построение-сети-и-загрузка-настроек-устройств)
#### Часть 2. [Отладка EtherChannel](READM.md#отладка-etherchannel)
#### [Конфигурационные файлы](READM.md#конфигурационные-файлы-здесь)
