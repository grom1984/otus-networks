...
#### Часть 3. [Изменение назначений идентификаторов маршрутизаторов](README.md#часть-3-изменение-назначенных-идентификаторов-маршрутизаторов-1)
