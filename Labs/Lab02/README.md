...
#### [Часть 4: Настроить сть VLAN расширенного диапазона ](README.md#часть-4-настроить-сеть-vlan-расширенного-диапазона)
...
Конфигурационные файлы коммутаторов [здесь](config/).
